...
This directory is the contributor-facing documentation surface for VoiceRAG Agent. Use this index to avoid treating historical audit files as current runtime truth.
...
| Current productionization summary | [operations/PRODUCTIONIZATION_SUMMARY.md](operations/PRODUCTIONIZATION_SUMMARY.md) |
| Verification evidence | [operations/VERIFICATION_MATRIX.md](operations/VERIFICATION_MATRIX.md) |
